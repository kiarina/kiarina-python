...
### Changed
- **kiarina-agi-data-builder, kiarina-agi-image**: Require Pillow 12.3.0 or later for security fixes.

## [2.21.0] - 2026-07-29

### Added
- **kiarina-agi-runner**: Add transport-neutral request and result models for delegating Agent workflow execution.
