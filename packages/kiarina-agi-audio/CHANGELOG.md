...
- Replace pydub and ffprobe-dependent TTS audio processing with direct FFmpeg processing through imageio-ffmpeg.
...
- Avoid external credentials and missing CI assets in audio provider tests.
