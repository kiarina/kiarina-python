...
if TYPE_CHECKING:
    ...
    from ._types.file_segment_normalizer_specifier import (
        FileSegmentNormalizerSpecifier,
    )
...
def __getattr__(name: str) -> object:
    ...
    module_map = {
        ...
        # ._instances
        "file_segment_normalizer_registry": "._instances.file_segment_normalizer_registry",
        # ._models
        ...
        "FileSegmentNormalizerName": "._types.file_segment_normalizer_name",
        "FileSegmentNormalizerSpecifier": "._types.file_segment_normalizer_specifier",
    }
