...
from kiarina.agi.file_info import FileInfo, ImageFileInfo
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            [
                {"uri_or_file_path": "jpg/apple_1024x1024_138kb.jpg"},
                {"uri_or_file_path": "jpg/apple_1024x1024_138kb.jpg"},
            ],
            1,
        ...
        pytest.param(
            [
                {"uri_or_file_path": "jpg/apple_1024x1024_138kb.jpg"},
                {"uri_or_file_path": "jpg/grid_4000x3000_1400kb.jpg"},
            ],
            2,
            id="a3. 2 files",
        ),
...
async def test_image(
    ...
    for spec in file_info_specs:
        ...
        assert isinstance(file.file_info, ImageFileInfo)
    ...
    print("Result:")
    for fi in result:
        assert isinstance(fi, ImageFileInfo)
        print(f"  {fi.uri_or_file_path} ({fi.width}x{fi.height})")
