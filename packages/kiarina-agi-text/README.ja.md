...
AI エージェント向けのチャット、ロギング、テキスト埋め込み API を提供します。

## Dependencies

必須依存関係は `kiarina-agi-base`、`kiarina-agi-data`、`kiarina-agi-file`、LangChain、Pydantic です。

optional implementation は個別の extra で導入できます。
