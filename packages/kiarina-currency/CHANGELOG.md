...
### Changed
- Improved package documentation, comments, docstrings, and settings metadata
...
### Added
- `get_system_currency()` function for automatic system currency detection from locale settings
