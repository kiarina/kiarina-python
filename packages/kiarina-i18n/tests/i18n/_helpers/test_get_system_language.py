...
def test_get_system_language_from_lang_env() -> None:
...
def test_get_system_language_from_lc_all_env() -> None:
...
def test_get_system_language_from_lc_messages_env() -> None:
...
def test_get_system_language_from_language_env() -> None:
...
def test_get_system_language_from_language_env_list() -> None:
...
def test_get_system_language_priority() -> None:
...
def test_get_system_language_without_encoding() -> None:
    """Test language detection without encoding suffix."""
    with patch.dict("os.environ", {"LANG": "ja_JP"}, clear=True):
        assert get_system_language() == "ja-JP"


def test_get_system_language_simple_code() -> None:
...
def test_get_system_language_from_locale() -> None:
...
def test_get_system_language_from_locale_without_encoding() -> None:
...
def test_get_system_language_fallback_to_en() -> None:
...
def test_get_system_language_empty_env_var() -> None:
