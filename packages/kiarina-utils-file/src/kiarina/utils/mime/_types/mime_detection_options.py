...
class MimeDetectionOptions(TypedDict, total=False):
    ...
    Attributes:
        ...
        ambiguous_extensions: Ambiguous extensions requiring content-based detection.
            Example: {".ts"} for TypeScript vs MPEG-2 Transport Stream
    """
    ...
    ambiguous_extensions: NotRequired[set[str]]
